  ...
  <div class="container d-flex flex-wrap justify-content-center py-5">
    ...
    <div>
      <div class="row col-12">
        <h2 class="fw-bold mb-4 text-center text-md-start" style="color: #e77e23;">
          Choose your pizza
        </h2>
        <!-- Pizza Card -->
        <div 
          class="col-sm-6 col-lg-4 mb-4 d-flex justify-content-center" 
...
const selectPizza = (pizza) => {
  ...
  emit("selectPizza", pizza.id);
};

watch(selectedSize, (newSize) => {
  emit("selectSize", newSize.id);
});

watch(selectedToppings, (newToppings) => {
  emit("selectToppings", newToppings);
});
